<template>
  <div class="container">
    <div v-if="house">
      ...
      <p class="address house-detail">Address: <br>{{ house.location.street }} {{ house.location.houseNumber }}{{ house.location.houseNumberAddition ? house.location.houseNumberAddition : '' }}, {{ house.location.city }}, {{ house.location.zip }}</p>
